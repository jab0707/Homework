...
#define nrn_init _nrn_init__NaCaex
#define _nrn_initial _nrn_initial__NaCaex
#define nrn_cur _nrn_cur__NaCaex
#define _nrn_current _nrn_current__NaCaex
#define nrn_jacob _nrn_jacob__NaCaex
#define nrn_state _nrn_state__NaCaex
#define _net_receive _net_receive__NaCaex 
...
extern Memb_func* memb_func;
 ...
 "setdata_NaCaex", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define dummy dummy_NaCaex
 double dummy = 0;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "ImaxNax_NaCaex", 0, 1e+006,
 "KcNacx_NaCaex", 0, 1e+006,
 "KnNacx_NaCaex", 0, 1e+006,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ImaxNax_NaCaex", "mA/cm2",
 "KnNacx_NaCaex", "mM",
 "KcNacx_NaCaex", "mM",
 "ica_NaCaex", "mA/cm2",
 "ina_NaCaex", "mA/cm2",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 7, "na_ion");
 	...
 	ivoc_help("help ?1 NaCaex C:/Users/Jake/Documents/GitHub/Homework/Homework/CellularBiophysics/lab4/cardiac1998/nacaex.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
 ...
 _lk = R * ( celsius + 273.14 ) / ( F * 1e-3 ) ;
   ...
   _lKqa = exp ( 0.35 * v / _lk ) ;
   _lKB = exp ( - 0.65 * v / _lk ) ;
   inacx = _lq10 * ImaxNax * ( _lKqa * pow( nai , 3.0 ) * cao - _lKB * pow( nao , 3.0 ) * cai ) / ( ( pow( KnNacx , 3.0 ) + pow( nao , 3.0 ) ) * ( KcNacx + cao ) * ( 1.0 + 0.1 * _lKB ) ) ;
   ina = 3.0 * inacx ;
   ica = - 2.0 * inacx ;
   }
 _current += ica;
