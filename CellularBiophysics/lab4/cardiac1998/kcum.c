...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_acc C:/Users/Jake/Documents/GitHub/Homework/Homework/CellularBiophysics/lab4/cardiac1998/kcum.mod\n");
 ...
 static double _zViF ;
static int _reset;
static char *modelname = "Potassium ion accumulation";
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 41 in file kcum.mod:\n	SOLVE state METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 1; ++_i) {
