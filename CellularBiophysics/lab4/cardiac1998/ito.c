...
#define nrn_init _nrn_init__Ito
#define _nrn_initial _nrn_initial__Ito
#define nrn_cur _nrn_cur__Ito
#define _nrn_current _nrn_current__Ito
#define nrn_jacob _nrn_jacob__Ito
#define nrn_state _nrn_state__Ito
#define _net_receive _net_receive__Ito 
#define rates rates__Ito 
#define states states__Ito 
...
extern Memb_func* memb_func;
 ...
 "setdata_Ito", _hoc_setdata,
 "alp_Ito", _hoc_alp,
 "bet_Ito", _hoc_bet,
 "ce_Ito", _hoc_ce,
 "rates_Ito", _hoc_rates,
 0, 0
};
#define alp alp_Ito
#define bet bet_Ito
...
#define mtau mtau_Ito
 double mtau = 0;
#define minf minf_Ito
 double minf = 0;
#define ntau ntau_Ito
 double ntau = 0;
#define ninf ninf_Ito
 double ninf = 0;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ito C:/Users/Jake/Documents/GitHub/Homework/Homework/CellularBiophysics/lab4/cardiac1998/ito.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double _zk ;
static int _reset;
static char *modelname = "Cardiac Ito  current";
...
double alp (  double _lv , double _li ) {
 ...
 _lv = _lv ;
   ...
   if ( _li  == 0.0 ) {
     ...
     _lalp = _lq10 / ( 18.53 + exp ( ( _lv + 113.7 ) / 10.95 ) ) ;
     }
...
double bet (  double _lv , double _li ) {
 ...
 _lv = _lv ;
   ...
   if ( _li  == 0.0 ) {
     ...
     _lbet = _lq10 / ( 35.56 + exp ( - ( _lv + 1.26 ) / 7.44 ) ) ;
     }
...
double ce (  double _lv , double _li ) {
 ...
 _lv = _lv ;
   if ( _li  == 0.0 ) {
     _lce = 1.0 / ( 1.0 + exp ( - ( _lv + 20.47 ) / 17.54 ) ) ;
     }
   else if ( _li  == 1.0 ) {
     _lce = 1.0 / ( 1.0 + exp ( ( _lv + 43.1 ) / 5.3 ) ) ;
     }
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 46 in file ito.mod:\n	SOLVE states METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 2; ++_i) {
